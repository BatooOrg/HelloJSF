...
import com.example.event.StudentCoursePayload;
import com.example.model.BaseEntity;
import com.example.model.Course;
import com.example.model.Person;
import com.example.model.Student;
import com.example.model.Teacher;
import com.example.qualifier.DataRepository;
import com.example.qualifier.StudentAdded;
import com.example.qualifier.StudentRemoved;
...
public class SchoolJpaDao implements SchoolDao {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Student> searchStudents(SearchCriteria criteria, int firstResult, int pageSize) {
		...
		if (criteria.getFirstName() != null && criteria.getFirstName().length() != 0) {
			...
			params.put("firstName", criteria.getFirstName().toUpperCase() + "%");
		}
	...
	@Override
	public void notifyCourseChanges(Student student, List<Course> originalCourseList) {
	...
	private void notifyStudentRemovedFromCourse(Student student, Course course) {
		removeStudentCourseEvent.fire(new StudentCoursePayload(student, course));
	}
