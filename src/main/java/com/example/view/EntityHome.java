...
public abstract class EntityHome<T extends BaseEntity> {
	 ...
	 * {@link EntityHome#doInit()} method which can be overriden by subclases to
	...
	/**
	 * Lazy loads the entity instance using the {@link EntityHome#fetchEntity()}
	 * method.
	 * 
	 * @return The entity
	 */
	 ...
	 * property is set or not. The {@link EntityHome#doLoadEntity()} and
	 * {@link EntityHome#doCreateEntity()} methods should be overriden in
