...
import com.example.bean.SchoolDao;
 ...
 * {@link PersonHome#isStudent()} method to indicate if this person is a student
 * and {@link PersonHome#isTeacher()} to indicate if it is a teacher.
 * <p/>
 ...
 * indicate which kind to create in the {@link PersonHome#doCreateEntity()}
 * method.
 * 
 * @author Andy Gibson
 * 
...
public class PersonHome extends EntityHome<Person> implements Serializable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.example.view.EntityHome#doInit()
	 */
	@Override
